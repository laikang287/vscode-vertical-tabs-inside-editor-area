...
import { type ExtensionMessage, type GroupMode, type ManualTabGroup, type SortMode, type TabInputKind, type TabTarget, type TabTargetIdentity, type VerticalTabsSnapshot, parseWebviewMessage } from './messages';
