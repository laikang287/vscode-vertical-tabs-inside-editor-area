...
const zhTw: LocaleStrings = {
  ...
  nativeContextMenuTitle: 'VS Code 水平分頁操作',
  nativeContextMenuWarning: '擷取自水平分頁選單，不保證相容性',
  nativeContextMenuDetails: '這些操作擷取自 VS Code 水平分頁選單，可能會受 VS Code 或已安裝擴充功能版本影響。將 verticalTabs.showNativeContextMenuActions 設為 false 即可隱藏此區段。',
  previewTab: '預覽標籤',
  pinnedTab: '固定標籤',
  readonlyResource: '唯讀',
