...
const ko: LocaleStrings = {
  ...
  nativeContextMenuTitle: 'VS Code 가로 탭 작업',
  nativeContextMenuWarning: '가로 탭 메뉴에서 가져오며 호환성이 보장되지 않습니다',
  nativeContextMenuDetails: '이 작업은 VS Code 가로 탭 메뉴에서 가져오므로 VS Code 또는 설치된 확장 버전에 따라 달라질 수 있습니다. verticalTabs.showNativeContextMenuActions를 false로 설정하면 이 섹션을 숨길 수 있습니다.',
  previewTab: '미리 보기 탭',
  pinnedTab: '고정된 탭',
