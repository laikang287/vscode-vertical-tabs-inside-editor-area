...
const ko: LocaleStrings = {
  ...
  moveGroup: '그룹 이동 위치',
  moveToTopLevel: '최상위',
  groupDepthLimit: '수동 그룹은 최대 3단계까지 지원됩니다',
  newGroupOnlyManual: '수동 그룹 모드만 새 그룹을 만들 수 있습니다',
  back: '뒤로',
  moveToGroup: '그룹으로 이동',
  moveToManualGroup: '수동 그룹으로 이동',
  moveToVscodeGroup: 'VS Code 편집기 그룹으로 이동',
  moveOutOfGroup: '그룹 밖으로 이동',
  moveToNamedGroup: '{0}(으)로 이동',
  unknownTab: '알 수 없는 탭',
  previewTab: '미리 보기 탭',
  pinnedTab: '고정된 탭',
  ...
  groupModeParentDirTree: "상위 디렉토리 트리",
