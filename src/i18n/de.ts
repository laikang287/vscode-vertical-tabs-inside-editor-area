...
const de: LocaleStrings = {
  ...
  nativeContextMenuTitle: 'Aktionen der horizontalen VS Code-Tabs',
  nativeContextMenuWarning: 'Aus dem horizontalen Tabmenü übernommen; Kompatibilität nicht garantiert',
  nativeContextMenuDetails: 'Diese Aktionen werden aus dem horizontalen Tabmenü von VS Code übernommen und können je nach VS Code- oder installierter Erweiterungsversion variieren. Setzen Sie verticalTabs.showNativeContextMenuActions auf false, um diesen Abschnitt auszublenden.',
