...
const ptBr: LocaleStrings = {
  ...
  moveGroup: 'Mover grupo para',
  moveToTopLevel: 'Nível superior',
  groupDepthLimit: 'Grupos manuais aceitam até três níveis',
  ...
  groupModeParentDirTree: "Árvore de diretórios pais",
