...
const ptBr: LocaleStrings = {
  ...
  nativeContextMenuTitle: 'Ações das guias horizontais do VS Code',
  nativeContextMenuWarning: 'Capturadas do menu de guias horizontais; compatibilidade não garantida',
  nativeContextMenuDetails: 'Essas ações são capturadas do menu de guias horizontais do VS Code e podem variar conforme a versão do VS Code ou das extensões instaladas. Defina verticalTabs.showNativeContextMenuActions como false para ocultar esta seção.',
