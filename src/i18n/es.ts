...
const es: LocaleStrings = {
  ...
  nativeContextMenuTitle: 'Acciones de las pestañas horizontales de VS Code',
  nativeContextMenuWarning: 'Obtenidas del menú de pestañas horizontales; compatibilidad no garantizada',
  nativeContextMenuDetails: 'Estas acciones se obtienen del menú de pestañas horizontales de VS Code y pueden variar según la versión de VS Code o de las extensiones instaladas. Establece verticalTabs.showNativeContextMenuActions en false para ocultar esta sección.',
