...
const fr: LocaleStrings = {
  ...
  nativeContextMenuTitle: 'Actions des onglets horizontaux de VS Code',
  nativeContextMenuWarning: 'Récupérées depuis le menu des onglets horizontaux ; compatibilité non garantie',
  nativeContextMenuDetails: 'Ces actions sont récupérées depuis le menu des onglets horizontaux de VS Code et peuvent varier selon la version de VS Code ou des extensions installées. Définissez verticalTabs.showNativeContextMenuActions sur false pour masquer cette section.',
