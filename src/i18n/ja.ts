...
const ja: LocaleStrings = {
  ...
  nativeContextMenuTitle: 'VS Code 横タブの操作',
  nativeContextMenuWarning: '横タブメニューから取得したため、互換性は保証されません',
  nativeContextMenuDetails: 'これらの操作は VS Code の横タブメニューから取得されるため、VS Code またはインストール済み拡張機能のバージョンによって変わる場合があります。verticalTabs.showNativeContextMenuActions を false に設定すると、このセクションを非表示にできます。',
  previewTab: 'プレビュー タブ',
  pinnedTab: '固定されたタブ',
