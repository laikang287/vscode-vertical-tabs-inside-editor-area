...
const ja: LocaleStrings = {
  ...
  newGroup: '新しいグループ',
  newSubgroup: '新しいサブグループ',
  moveGroup: 'グループの移動先',
  moveToTopLevel: '最上位',
  groupDepthLimit: '手動グループは最大 3 階層です',
  newGroupOnlyManual: '手動グループモードのみ新しいグループを作成できます',
  back: '戻る',
  moveToGroup: 'グループへ移動',
  moveToManualGroup: '手動グループへ移動',
  moveToVscodeGroup: 'VS Code エディターグループへ移動',
  moveOutOfGroup: 'グループから移動',
  moveToNamedGroup: '{0} へ移動',
  unknownTab: '不明なタブ',
  previewTab: 'プレビュー タブ',
  pinnedTab: '固定されたタブ',
  ...
  groupModeParentDirTree: "親ディレクトリツリー",
