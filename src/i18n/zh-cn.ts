...
const zhCn: LocaleStrings = {
  ...
  nativeContextMenuTitle: 'VS Code 横向标签操作',
  nativeContextMenuWarning: '来自横向标签菜单，兼容性不保证',
  nativeContextMenuDetails: '这些操作从 VS Code 横向标签菜单抓取，可能受 VS Code 或其它扩展版本影响。可将 verticalTabs.showNativeContextMenuActions 设为 false 关闭此区域。',
  previewTab: '预览标签',
  pinnedTab: '固定标签',
  readonlyResource: '只读',
