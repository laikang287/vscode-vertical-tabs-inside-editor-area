...
const ru: LocaleStrings = {
  ...
  moveGroup: 'Переместить группу в',
  moveToTopLevel: 'Верхний уровень',
  groupDepthLimit: 'Ручные группы поддерживают до трех уровней',
  ...
  groupModeParentDirTree: "Дерево родительских каталогов",
