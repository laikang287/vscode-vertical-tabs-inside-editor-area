...
const ru: LocaleStrings = {
  ...
  nativeContextMenuTitle: 'Действия горизонтальных вкладок VS Code',
  nativeContextMenuWarning: 'Получены из меню горизонтальных вкладок; совместимость не гарантируется',
  nativeContextMenuDetails: 'Эти действия получены из меню горизонтальных вкладок VS Code и могут отличаться в зависимости от версии VS Code или установленных расширений. Установите verticalTabs.showNativeContextMenuActions в false, чтобы скрыть этот раздел.',
